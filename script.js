document.addEventListener('DOMContentLoaded', () => {
    ...
    const scriptURL = 'https://script.google.com/macros/s/AKfycbwZMEbcOlrYmKQ0m5TGAg7lWGPw3QaXFor1C4R1D_Mu5jds3kAt5QeapfdzRVyCxgo/exec';
    ...
    qualifyForm.addEventListener('submit', (e) => {
        ...
        if (scriptURL.includes('TU_DEPLOYMENT_ID')) {
            alert('⚠️ Error de configuración: Actualiza la URL del script en script.js');
            return;
        }
        ...
        console.log('Negocio:', formData.get('business'));
        console.log('Situación:', formData.get('revenue'));
        ...
        .then(data => {
            ...
            if (data.result === 'success') {
                ...
                formSuccess.textContent = '¡Gracias! Tus datos se guardaron correctamente. ID: <br> Abriendo Notion..' + data.id;
